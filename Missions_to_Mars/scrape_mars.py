...
mars_list = [{'title':cerberus_title, 'img_url':cerberus_image}, {'title':schiaparelli_title, 'img_url':schiaparelli_image},
            {'title':syrtis_title, 'img_url':syrtis_image}, {'title':valles_title, 'img_url':valles_image}]
mars_list
...
def mongo_insert():
    scrape()
    return db.mars_collection.insert(mars_dictionary)
